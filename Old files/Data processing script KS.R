...
#Reformatting dataframe
df_dupes_removed <- df_dupes_removed[df_dupes_removed$State == "Kansas",]
...
#Create output files
xlsx::write.xlsx(x = data.frame(df_wide), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_Connectivity_KS.xlsx")
xlsx::write.xlsx(x = data.frame(df_wide_perc), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_Connectivity_KS.xlsx",sheetName = "Percent",append = TRUE)
...
#Create output files
xlsx::write.xlsx(x = data.frame(df_wide), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_locale_KS.xlsx")
xlsx::write.xlsx(x = data.frame(df_wide_perc), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_locale_KS.xlsx",sheetName = "Percent",append = TRUE)
...
#Create output files
xlsx::write.xlsx(x = data.frame(df_wide), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_quartile_KS.xlsx")
xlsx::write.xlsx(x = data.frame(df_wide_perc), file = "C:/Users/DavidMcCullough/Marzano Research/MZR - Share/10_REL/Task 6-Research/CE6.6_JiT/Data Entry/Analysis/output/Aggregated_quartile_KS.xlsx",sheetName = "Percent",append = TRUE)
